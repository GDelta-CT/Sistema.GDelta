...
const DIFERENCIAIS: Diferencial[] = [
  ...
  },
  {
    ...
    titulo: 'Cilia registra;',
    destaque: 'o G Delta interpreta.',
    texto:
      'DRE pronto, markup real por serviço, ranking do que dá lucro e o semáforo do mês. Não é um relatório que você precisa decifrar — é a leitura que diz onde está o dinheiro.',
    bullets: [
      ...
      { icon: TrendUp, texto: 'Ranking: os serviços que puxam o seu lucro' },
    ],
  ...
  },
  {
    ...
    titulo: 'O pátio inteiro,',
    destaque: 'em dias e em reais.',
    texto:
      'Cada carro na oficina vira um número: quantos dias parado, quanto está custando, onde está o gargalo e o que voltou para retrabalho. O chão de fábrica deixa de ser invisível.',
    bullets: [
      { icon: Clock, texto: 'Dias na oficina × R$ por veículo, em tempo real' },
