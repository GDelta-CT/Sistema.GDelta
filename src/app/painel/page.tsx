...
export default function PainelPage() {
  ...
  const navItems: { href: string; titulo: string; desc: string; Icone: Icon }[] = [
    ...
    },
    {
      ...
      titulo: 'Despesas',
      desc: 'Custos fixos e variáveis, por categoria.',
      Icone: Money,
    },
    {
      href: '/painel/fornecedores',
      titulo: 'Fornecedores',
      desc: 'Contas a pagar com status e vencimento.',
      Icone: Storefront,
    },
    {
      href: '/painel/aging',
      titulo: 'Aging',
      desc: 'Idade de recebíveis e pagáveis, por faixa.',
      Icone: ClockCountdown,
    },
    {
      href: '/painel/fluxo',
      titulo: 'Fluxo de caixa',
      desc: 'Projeção semanal — evita o saldo negativo.',
      Icone: Wallet,
    },
    {
      href: '/painel/estoque',
