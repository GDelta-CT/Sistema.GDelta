...
Passos:
1. Determine se o alvo é código (um path) ou lógica (uma lista de gaps/decisões, ex.: do `.agents-guru/gap-report.md`).
...
3. Dispare o agente `dependency-tracer`. Peça:
   ...
   - confiança do mapa.
4. Reporte ao usuário e ofereça salvar em `.agents-guru/dependency-map.md`.
